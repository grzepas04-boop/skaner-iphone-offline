import{C as e,D as t,E as n,i as r,p as i,r as a}from"./index--tewgmG4.js";var o=class{parse(o){let s=``,c=0,l=0,u=0,d=new t,f=new a,p=new t,m=new n,h=[];function g(e){let t=0,n=0,r=0,a=e.geometry,o=new i,f=a.getAttribute(`position`),g=a.getAttribute(`normal`),_=a.getAttribute(`uv`),v=a.getIndex();if(s+=`o `+e.name+`
...
//# sourceMappingURL=OBJExporter-C3Ik5t1C.js.map